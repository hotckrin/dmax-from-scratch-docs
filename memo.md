...
- [x] dmax.py の準備
- [x] mini 別の実行方法の修正
- [x] dmax-practice を mini 側に追加、 __main__ 削除対応
- [x] コードのアップロード

- [x] github へのリンクを差し込んでいく
- [x] すぐ試したい人向けの解説
  - [x] web版 dmax mhwilds の動作イメージ図
  - [x] コード動かし方
- [x] 環境構築 記事とアップロードされたコードをベースに実行できることまで確認する
- [x] dmax.py の解説 ちょっとだけ書く
- [x] 参考文献などをまとめる
  - [x] 他のソルバーよりよい理由 [Pyomo×SCIPは組合せ最適化にて最強… 覚えておけ](https://nttdocomo-developers.jp/entry/2024/12/20/090000_7)
- [x] 見出しの整理
...
- [ ] ponti2 の文字を大きくする
- [ ] ponti3 推定し、に書き換える
- [ ] table5.drawio.png に解1を加える
- [ ] table8.drawio.png のみす Q(j)
...
- [ ] initialize= のデータに不整合があればエラーが出力されます。の例

- [ ] DMAX MHWilds のソースコード公開？
